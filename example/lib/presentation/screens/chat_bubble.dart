...
class ChatBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget bubbleContent = Text(
      message,
      softWrap: true,                 // ✅ 줄바꿈 보장
      overflow: TextOverflow.visible, // ✅ 말풍선 밖으로 안 튀게
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          if (colWidth >= 1200) {
            ...
            capPx = double.infinity; // 모바일은 순수 0.3 비율
          }

          // 네 요구: 작은 화면에서는 0.3 유지
