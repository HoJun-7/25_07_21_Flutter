...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _toggleNotificationPopup() {
    setState(() {
      _isNotificationPopupVisible = !_isNotificationPopupVisible;
    });
  }

  // 팝업 외부 탭 시 닫기 위해 GestureDetector 감싸기 위해 배경영역 터치시 닫는 함수
  void _closeNotificationPopup() {
    if (_isNotificationPopupVisible) {
      setState(() {
        _isNotificationPopupVisible = false;
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: GestureDetector(
        ...
        onTap: _closeNotificationPopup, // 팝업 외부 터치시 팝업 닫기
        child: Scaffold(
